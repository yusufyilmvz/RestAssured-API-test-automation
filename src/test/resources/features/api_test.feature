...
#    Given I send a GET request to "/api/v1/resource" with token "Bearer xyz" and no headers or query parameters
#    Then the response status code should be 200
#    And the response body should be of type "YourResponseClass"
